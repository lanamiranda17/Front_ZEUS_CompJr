...
function Tela_orcamento() {
  ...
  // Valores e variações para os cards de resumo
  ...
  // Renderização principal da tela de orçamentos
  return (
    <Layout_Nav>
      {/* Topo da tela com título e navegação */}
