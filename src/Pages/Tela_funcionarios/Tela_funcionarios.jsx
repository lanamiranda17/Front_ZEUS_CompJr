...
// Componente de listagem e filtro de funcionários
function Tela_funcionarios() {
  ...
  // Colunas e dados simulados da tabela de funcionários
  ...
  // Renderização principal da tela de funcionários
  return (
    <Layout_Nav>
      <div className='Tela_toda_funcionarios'>
        <div className='Funcionario_card'>
          <div className='Top_funcionarios'>
            <div className='Top_esquerda_funcionarios'>
              <img src={Icon_func} className="Icon_func" />
              <div className='Texto_topo_funcionarios'>
                <p className='Texto_titulo_funcionarios'>Funcionários</p>
                <p className='Texto_subtitulo_funcionarios'>Visualizar, filtrar e adicionar funcionários.</p>
              </div>
            </div>
            <Top_direita />
          </div>
          {/* Filtros e pesquisa */}
          <div className='Filtros_funcionarios'>
